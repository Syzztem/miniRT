...
/*   Updated: 2020/01/16 10:43:13 by lothieve         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		lerp_light(t_light *light, t_ray normal_ray, t_color albedo, t_scene scene)
{
	...
	while (light)
	{
		...
		color = col_add(col_multiply_c(albedo, col_multiply(scene.ambient_light.color, scene.ambient_light.intensity)), color);
