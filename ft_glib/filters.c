...
/*   Updated: 2020/08/04 19:22:20 by lothieve         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_image	*filter_bw(t_image *image)
{
	...
	while (i < total_size)
	{
		...
		current_pixel->r = (current_pixel->r + current_pixel->g + current_pixel->b) / 3;
...
t_image	*filter_sepia(t_image *image)
{
	...
	{
		current_pixel = (t_color *)&image->img_data[i];
		t.x = 0.393 * current_pixel->r + 0.769 * current_pixel->g + 0.189 * current_pixel->b;
		t.y = 0.349 * current_pixel->r + 0.686 * current_pixel->g + 0.168 * current_pixel->b;
		t.z = 0.272 * current_pixel->r + 0.534 * current_pixel->g + 0.131 * current_pixel->b;
